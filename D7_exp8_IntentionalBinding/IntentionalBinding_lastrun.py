...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ayush\\OneDrive\\Desktop\\Lab in Psych\\Classwork\\D7_exp8_IntentionalBinding\\IntentionalBinding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        ...
        trialList=data.importConditions('IntentionalBindingConditions.csv'),
    ...
    for thisTrial in trials:
        ...
        trialComponents = [fixation, polygon_2, key_resp]
